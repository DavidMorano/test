/* testatox_main SUPPORT (testatox) */
/* charset=ISO8859-1 */
/* lang=C++20 */
...
/*******************************************************************************
	...
	Description:
	This test program tests the |atoxl(3u)| subroutine.  I
	...
	function: either |atoxl(3)| or |atoxul(3u)|.  For
