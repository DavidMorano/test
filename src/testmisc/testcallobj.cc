...
local int	ourobj_hand(void *,uint,int) ;
...
local int ourobj_hand(void *objp,uint tag,int arg) {
...
local int	maininfo_time(MAININFO *,time_t,int) ;
...
local int maininfo_time(MAININFO *mip,time_t dt,int tval) noex {
	ourobj		os ;
	int		rs ;
