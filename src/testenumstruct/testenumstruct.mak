...
DEPS_MAIN += testenumstruct_mod.o
DEPS_MAIN +=
DEPS_MAIN += 

OBJ0= testenumstruct_main.o
OBJ1= testenumstruct_mod.o
OBJ2=
OBJ3= 
OBJ4=
OBJ5=
...
testenumstruct_main.o:	testenumstruct_main.cc $(DEPS_MAIN)	$(INCS)
...
testenumstruct_mod.o:	testenumstruct_mod0.o testenumstruct_mod1.o
	$(LD) -r $(LDFLAGS) -o $@ $^

testenumstruct_mod0.o:	testenumstruct_mod.ccm
	gxx -c -x c++ -o $@ $(CPPFLAGS) $(CXXFLAGS) $<

testenumstruct_mod1.o:	testenumstruct_mod1.cc testenumstruct_mod0.o
	$(COMPILE.cc) $<
