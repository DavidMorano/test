...
#ifdef	COMMENT
static int	prepname_start(struct prepname *,const char *) ;
static int	prepname_finish(struct prepname *) ;
#endif
...
static int prepname_start(ep,name)
struct prepname	*ep ;
const char	name[] ;
{
	int	rs = SR_OK ;
